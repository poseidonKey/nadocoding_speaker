...
def answer(input_text):
    answer_text = ""
    if "안녕" in answer_text:
        answer_text = "안녕하세요? 반갑습니다."
    elif "날씨" in answer_text:
        answer_text = "오늘의 서울 기온은 20도 입니다. 맑은 하늘이 예상됩니다."
    elif "환율" in answer_text:
        answer_text = "원 달러 환율은 1380원입니다."
    elif "고마워" in answer_text:
        answer_text = "별 말씀을요."
    elif "종료" in answer_text:
...
# stop_listening(wait_for_stop=False) # 더 이상 듣지 않는다. 스톱
